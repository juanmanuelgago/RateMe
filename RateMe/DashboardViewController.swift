        ...
        if filtersFlag || searching {
            if filteredUsers.count == 0 {
                if activityIndicator.isAnimating {
                    collectionView.setEmptyView(title: "Wait", message: "Getting users...")
                } else {
                    collectionView.setEmptyView(title: "Ups!", message: "No users matching the filters applied.")
                }
            ...
            if users.count == 0 {
                if activityIndicator.isAnimating {
                    ...
                    collectionView.setEmptyView(title: "Ups!", message: "It seems you have no friends!")
                }
            } else {
                collectionView.restore()
            }
